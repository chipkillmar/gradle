...
public class DefaultResolutionStrategy implements ResolutionStrategyInternal {
    ...
    @Override
    public boolean matchArtifactsAttributes(AttributeContainer providedAttributes) {
        return transforms.matchArtifactsAttributes(artifactsQuery, providedAttributes);
    }
